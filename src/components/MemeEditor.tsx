...
export const MemeEditor = () => {
  ...
  useEffect(() => {
    ...
    initialCanvas.on("selection:created", (e) => { //fires when you click a text object.
    ...
    initialCanvas.on("selection:updated", (e) => { //fires when you switch between different text objects.
      const activeObject = e.selected?.[0]
      if (activeObject && activeObject.type === "textbox") {
        const textObj = activeObject as fabric.Textbox
        setSelectedObject(textObj)
    ...
    initialCanvas.on("selection:cleared", () => { //fires when you click off everything.
  ...
  const toggleUppercase = () => {
    ...
    const newText = newUppercase ? currentText.toUpperCase() : currentText.toLowerCase()
    ...
    <div className="flex gap-6 p-6 max-w-6xl mx-auto">
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-center mb-4">
          <canvas ref={canvasEl} className="border border-gray-300 rounded-lg shadow-lg" />
        </div>

        <div className="text-center">
          <Button onClick={addNewText} className="bg-blue-500 hover:bg-blue-600">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className={isBold ? "bg-blue-500 text-white" : "bg-white text-black"}
                >
                ...
                <Button
                  ...
                  disabled={!selectedObject}
                  className={isItalic ? "bg-blue-500 text-white" : "bg-white text-black"}
                >
                ...
                <Button
                  ...
                  disabled={!selectedObject}
                  className={isUppercase ? "bg-blue-500 text-white" : "bg-white text-black"}
                >
                  ABC
                </Button>
              </div>
